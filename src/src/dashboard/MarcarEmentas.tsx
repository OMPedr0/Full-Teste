...
const checkmarks = firestore.collection('marcar');
  ...
  return (
    <div>
      ...
      <div className='flex flex-col justify-center items-center h-screen'>
        <form className="bg-white border-zinc-900 shadow-md rounded p-6 w-full sm:w-4/12 mx-4" onSubmit={handleSubmit}>
          <div className="grid grid-cols-2 gap-6 items-center justify-center  ">
            ...
            <input
              ...
              className="rounded border border-gray-400 px-4 py-2 w-fit"
